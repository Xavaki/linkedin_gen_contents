from CLOUD_PIPELINE.SCRIPTS.E_check_content_validity.A_create_batch_files import main as create_batch_files
from CLOUD_PIPELINE.SCRIPTS.E_check_content_validity.B_submit_batch_jobs import main as submit_batch_jobs
from CLOUD_PIPELINE.SCRIPTS.E_check_content_validity.C_retrieve_output_files import main as retrieve_output_files
from CLOUD_PIPELINE.SCRIPTS.E_check_content_validity.D_process_outputs import main as process_outputs
